...
merge_data = sc.read_h5ad("../results_dlpfc2/multiple_adata2.h5ad")
...
# # plt.savefig('../results_dlpfc2/umap_comparison2_DLPFC.png')

# # import scib
# # sc.pp.neighbors(merge_data, use_rep="correct")
# # scib.me.graph_connectivity(merge_data, label_key="celltype")
# # scib.me.ilisi_graph(merge_data, batch_key="batch", type_="embed", use_rep="correct")
# # scib.me.kBET(merge_data, batch_key="batch", label_key="celltype", type_="embed", embed="correct")
# # #scib.me.kBET(adata, batch_key="batch", label_key="ceelltype", type_="knn")
# # scib.me.silhouette_batch(merge_data, batch_key="batch", label_key="celltype", embed="correct")
