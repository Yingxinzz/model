...
def plot_all_umaps():
    ...
    ax_list[0].text(0.05, 1.05, 'A', ha='center', va='bottom', fontsize=32, fontweight='bold', transform=ax_list[0].transAxes)
    # ---- B 部分：Clustering 对比图 ----
    sc.pl.umap(adata_raw, color='mclust', ax=ax_list[7], title='RAW', show=False)
    sc.pl.umap(adata_PRECAST, color='cluster', ax=ax_list[8], title='PRECAST_leiden', show=False)
    sc.pl.umap(adata_DeepST, color='DeepST_refine_domain', ax=ax_list[9], title='DeepST', show=False)
    sc.pl.umap(adata_STAligner, color='mclust', ax=ax_list[10], title='STAligner_mclust', show=False)
    sc.pl.umap(adata_GraphST, color='domain', ax=ax_list[11], title='GraphST', show=False)
    sc.pl.umap(adata_SPIRAL, color='mclust', ax=ax_list[12], title='SPIRAL_mclust', show=False)
    sc.pl.umap(adata_Spatialign, color='mclust', ax=ax_list[13], title='Spatialign_GM', show=False)
    ax_list[7].text(0.05, 1.05, 'B', ha='center', va='bottom', fontsize=32, fontweight='bold', transform=ax_list[7].transAxes)
    # ---- C 部分：spatial ----
    spot_size=200
    sc.pl.spatial(adata_raw, color='mclust', ax=ax_list[14], title='RAW', spot_size=spot_size, cmap='viridis', show=False)
    sc.pl.spatial(adata_PRECAST, color='cluster', ax=ax_list[15], title='PRECAST_leiden', spot_size=spot_size, cmap='viridis', show=False)
    sc.pl.spatial(adata_DeepST, color='DeepST_refine_domain', ax=ax_list[16], title='DeepST', spot_size=spot_size, cmap='viridis', show=False)
    sc.pl.spatial(adata_STAligner, color='mclust', ax=ax_list[17], title='STAligner_mclust', spot_size=spot_size, cmap='viridis', show=False)
    sc.pl.spatial(adata_GraphST, color='domain', ax=ax_list[18], title='GraphST', spot_size=spot_size, cmap='viridis', show=False)
    sc.pl.spatial(adata_SPIRAL, color='mclust', ax=ax_list[19], title='SPIRAL_mclust', spot_size=spot_size, cmap='viridis', show=False)
    sc.pl.spatial(adata_Spatialign, color='mclust', ax=ax_list[20], title='Spatialign_GM', spot_size=spot_size, cmap='viridis', show=False)
...
def plot_all_umaps():
    ...
    sc.pp.neighbors(adata_raw, use_rep='X', random_state=666)
    sc.tl.umap(adata_raw, random_state=666)
    sc.pl.umap(adata_raw, color='new_batch', title='RAW_Uncorrected', ax=ax_list[0], show=False)
    sc.pp.neighbors(adata_PRECAST, use_rep='PRECAST', random_state=666)
    sc.tl.umap(adata_PRECAST, random_state=666)
    sc.pl.umap(adata_PRECAST, color='new_batch', ax=ax_list[1], title='PRECAST', show=False)
    sc.pp.neighbors(adata_DeepST, use_rep='DeepST_embed', random_state=666)
...
def plot_all_umaps():
    ...
    sc.pp.neighbors(adata_raw, use_rep='X', random_state=666)
    sc.tl.umap(adata_raw, random_state=666)
    sc.pl.umap(adata_raw, color='batch_name', title='RAW_Uncorrected', ax=ax_list[0], show=False)
    sc.pp.neighbors(adata_PRECAST, use_rep='PRECAST', random_state=666)
    sc.tl.umap(adata_PRECAST, random_state=666)
    sc.pl.umap(adata_PRECAST, color='sample_group', ax=ax_list[1], title='PRECAST', show=False)
    sc.pp.neighbors(adata_DeepST, use_rep='DeepST_embed', random_state=666)
    sc.tl.umap(adata_DeepST, random_state=666)
    sc.pl.umap(adata_DeepST, color='sample_name', ax=ax_list[2], title='DeepST', show=False)
    sc.pp.neighbors(adata_STAligner, use_rep='STAligner', random_state=666)
    sc.tl.umap(adata_STAligner, random_state=666)
    sc.pl.umap(adata_STAligner, color='batch_name', title='STAligner', ax=ax_list[3], show=False)
    sc.pp.neighbors(adata_GraphST, use_rep='emb_pca', n_neighbors=10, random_state=666)
    sc.tl.umap(adata_GraphST, random_state=666)
    sc.pl.umap(adata_GraphST, color='batch_name', ax=ax_list[4], title='GraphST', show=False)
    sc.pp.neighbors(adata_SPIRAL, use_rep='spiral', random_state=666)
    sc.tl.umap(adata_SPIRAL, random_state=666)
    sc.pl.umap(adata_SPIRAL, color='batch_name', ax=ax_list[5], title='SPIRAL', show=False)
    sc.pp.neighbors(adata_STitch3D, use_rep='latent', n_neighbors=30, random_state=666)
    adata_STitch3D.obsm['X_umap'] = reducer.fit_transform(adata_STitch3D.obsm['latent'])
    sc.pl.umap(adata_STitch3D, color='batch_name', title='STitch3D', ax=ax_list[6], show=False)
    sc.pp.neighbors(adata_Spatialign, use_rep='correct', random_state=666)
    sc.tl.umap(adata_Spatialign, random_state=666)
    sc.pl.umap(adata_Spatialign, color='new_batch', ax=ax_list[7], title='Spatialign', show=False)
    ax_list[0].text(0.05, 1.05, 'A', ha='center', va='bottom', fontsize=32, fontweight='bold', transform=ax_list[0].transAxes)
    ...
    spot_size=100
    sc.pl.spatial(adata_raw, color='mclust', ax=ax_list[24], title='RAW', spot_size=spot_size, cmap='viridis', show=False)
    sc.pl.spatial(adata_PRECAST, color='cluster', ax=ax_list[25], title='PRECAST_leiden', spot_size=spot_size, cmap='viridis', show=False)
    sc.pl.spatial(adata_DeepST, color='DeepST_refine_domain', ax=ax_list[26], title='DeepST', spot_size=spot_size, cmap='viridis', show=False)
    sc.pl.spatial(adata_STAligner, color='mclust', ax=ax_list[27], title='STAligner_mclust', spot_size=spot_size, cmap='viridis', show=False)
    sc.pl.spatial(adata_GraphST, color='domain', ax=ax_list[28], title='GraphST', spot_size=spot_size, cmap='viridis', show=False)
    sc.pl.spatial(adata_SPIRAL, color='mclust', ax=ax_list[29], title='SPIRAL_mclust', spot_size=spot_size, cmap='viridis', show=False)
    sc.pl.spatial(adata_STitch3D, color='Cluster', ax=ax_list[30], title='STitch3D_GM', spot_size=spot_size, cmap='viridis', show=False)
    sc.pl.spatial(adata_Spatialign, color='mclust', ax=ax_list[31], title='Spatialign_GM', spot_size=spot_size, cmap='viridis', show=False)
    ax_list[24].text(0.05, 1.05, 'D', ha='center', va='bottom', fontsize=32, fontweight='bold', transform=ax_list[24].transAxes)
...
def plot_all_umaps():
    ...
    layer_palette_SPIRAL = create_layer_palette(adata_SPIRAL)
    layer_palette_Spatialign = create_layer_palette(adata_Spatialign)
    # Pass the colormap directly to `palette`
...
sc.tl.umap(adata_raw, random_state=666)
sc.pl.umap(adata_raw, color='slice_name', title='RAW_uncorrected', ax=ax_list[0], show=False)
...
######### 第二行：聚类结果 UMAP #########
# sc.pl.umap(adata_DeepST, color='DeepST_refine_domain', ax=ax_list[5], title='DeepST', show=False)
