...
spot_size=100
sc.pl.spatial (adata_raw,color='celltype',title='RAW_spatial_truth', ax=ax_list[4], spot_size=spot_size, cmap='viridis', show=False)
sc.pl.spatial (adata_raw,color='mclust',title='RAW_spatial_cluster', ax=ax_list[5], spot_size=spot_size, cmap='viridis', show=False)
...
umap_titles_corrected = ['corrected', 'Ground_Truth', 'Colored by clusters']
umap_colors_corrected = ['batch_name', 'Ground_Truth', 'mclust']
...
sc.pl.paga(adata, color='Ground_Truth', title='PAGA plot with STAligner', ax=ax_list[10], show=False)
spot_size=100
sc.pl.spatial (adata,color='Ground_Truth',title='spatial_truth', ax=ax_list[11], spot_size=spot_size, cmap='viridis', show=False)
sc.pl.spatial (adata,color='mclust',title='spatial_cluster', ax=ax_list[12], spot_size=spot_size, cmap='viridis', show=False)
...
for i, gene in enumerate(genes):
    ...
    ax_list[28 + i].set_title(f'Raw mclust - {gene}')
