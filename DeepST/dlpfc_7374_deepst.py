...
multiple_adata = ad.read_h5ad("../Results/multiple_adata_7374.h5ad")
...
# sc.pl.umap(multiple_adata, color='new_batch', title='Uncorrected', ax=ax_list[0], show=False)
sc.pp.neighbors(multiple_adata, use_rep='DeepST_embed',random_state=666) 
sc.tl.umap(multiple_adata,random_state=666)
sc.pl.umap(multiple_adata, color='new_batch', ax=ax_list[0], title='Batch corrected', show=False)
...
scib.me.ilisi_graph(multiple_adata, batch_key="new_batch",type_="embed",use_rep="DeepST_embed")
scib.me.kBET(multiple_adata, batch_key="new_batch", label_key="ground_truth", type_="embed", embed="DeepST_embed")
scib.me.silhouette_batch(multiple_adata, batch_key="new_batch", label_key="ground_truth", embed="DeepST_embed")#绘制每个数据集的空间图
...
#for data_name in data_name_list:
	#adata = multiple_adata[multiple_adata.obs["new_batch"]==data_name]
