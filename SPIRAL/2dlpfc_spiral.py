...
model_file=('../results/model/SPIRAL_embed_1024_151669_151670_151671_151672.pt')
model = SPII.model
...
ann = sc.read_h5ad('../results/spiral_Sample2_DLPFC.h5ad')
...
# # plt.tight_layout()
# # plt.savefig('../results/umap_comparison2_DLPFC.png')
